label day_event_anendophasia:
    ...
    meme "Yeah, spot on. Why {i}are{/i} you narrating?"
    ...
    label anendophasia_pay:
        ...
        player "...Thanks, I guess. It'd better work."
        meme neutral "Have you never taken shrooms before?"
        player "No??"
        meme happy "Just eat it! It's simple."
        meme "Hehe, [player_name] eats the shroom happily."
        player "I am NOT happy!!!"
        player "...So when does it kick in?"
        meme neutral "Oh, it should-"
        ...
        player "YOU'RE BACK??"
        n "Hi."
        n "You quickly scramble to your feet and- hug the wall...?"
        ...
        n "You {i}clumsily{/i} make your way down to the lounge, no doubt to feed your ravaging coffee addiction once more. In fact, you haven't had a single productive minute since you arrived here today. Rather, you've just been running around like a headless chicken-"
        player "Shut. It."
        n "Hehe. All's well that ends well."
        n "Reunited once more with the coolest person in the world, you make your way back to your cubicle to tackle some spreadsheets."
        n "Or at least, pretend to."
        $ update_character_points({"meme": 1})
        return

    label anendophasia_ad:
        meme "Free advertising! Let's GO!!!"
        meme "Okay, here! You can take this sign and sit in the lounge for a few hours. Sound good?"
        player "Yeah, yeah. I grab the sign from Meme. It reads:"
        # show cg
        ...
        meme "Meme skips out of the room happily! Bye!"
        show meme at disappear
        player "..."
        player "Well..."
        show bg lounge
        player "I reluctantly make my way over to the lounge. In there, I see that three other people are already there."
        show chan at appear
        show ryz at appear(x_align = 0.3)
        show helco at appear(x_align = 0.7)
        chan "...which is why we need to crack down on Meme's drug business as soon as possible. I-"
        chan "Oh, intern. What's that you're carrying?"
        player "..."
        chan fury "..."
        player "Could I interest you gentlemen in Meme's Premium Shrooms?"
        chan "MY OFFICE. NOW."
        ...
        chan "That sly bastard...they would stoop this low?"
        ...
        player "YOU'RE BACK???"
        n "Hi."
        n "I never actually left, you know. It's just that your mind was so warped from Meme's coffee that you couldn't hear me."
        n "Seems like the effects wore off, though."
