label day_event_company_issued_gun:
    ...
    n "The Egg reappears out of the drawer, now larger and rectangle shaped." #rectangle egg cg????
    ...
    n "You reach out to grab it when The Egg hops onto the upper half of the case, slamming it shut. It smiles at you and your fingers that were 2 inches from being sandwiched by the case."
    ...
    player "I thought all employees are delegated for one."
    egg "That is correct. The outcome of this questionnaire will simply dictate which security level arms you can be assigned."
    $ gun_sanity_points = 0
    menu:
        egg "First question: Under what situations can you fire your company issued gun?" 
        ...
        "When I feel like it":
            ...
            egg sad "mhm."
    menu:
        egg "Question two: What are appropriate targets for shooting?"
        "Anomalies":
            $ gun_sanity_points -= 1
            n "The Egg wobbles."
        "Co-workers":
    ...
    menu:
        egg "Last question: Where do you aim your first shot?"
        ...
        "Aim?":
            egg sad "mhm."
            $ gun_sanity_points -= 1
    if gun_sanity_points < -1:
        show egg move_to(x_align = 1.5)
        ...
        n "The Egg floats back on top of its assistant's head. It smiles at you satisfyingly."
    ...
    label comgun_af:
        ...
        menu: 
            ...
            "Corporal anomaly proximity radar - chan":
                # show cg
                eggs "This is developed by Dr. Chan and detects if there are any anomalies near you! Doesn't work for non corporal Cerebersites though."
                $ gun_temp = chan
            "Owner locator - ufo":
                # show cg
    ...
    label comgun_lu:
        ...
        menu: 
            ...
            "Hamp certified sharpened spoons (reusable and reloadable!) - hamp":
                ...
                $ gun_temp = hamp
            "A very large medical bill - paul":
                # show cg
    ...
    label gun_yes_no:
        menu:
            ...
            "Yes":
                ...
                $ update_characters_points({gun_temp: 2})
                $ n_o_gun_addons += 1
                if n_o_gun_addons == 3:
                    jump comgun_end
            "No":
