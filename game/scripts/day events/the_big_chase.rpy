label day_event_the_big_chase:
    ...
    n "Behind the creature, two more pairs of legs run after the them, albeit with less elegance and a slower pace."
    show hampter panic
    hampter "Help me!"
    ...
    label help_hampter:
        ...
        n "Pochi growls at you and starts biting your ankles. Its bite hurts a lot for something so non-threatening."
        # un-render graphic, so just back to the hallway
        n "The two figures in lab coats finally catch up enough for you to identify them. It is Dr Chan and Dr Syg."
        ...
        syg "I would like Pochi instead. I have been trying to sample it for my research."
        ...
        label chan_hard_drive:
            ...
            n "You swing your ankle in Dr Chan's direction and Pochi is set free from your ankle, slamming into the ceiling halfway between you and Dr Chan."
            chan "..."
        ...
        label syg_experiment:
            player "Okay, Dr Syg."
            n "Dr Syg doesn't actually require you help, seeing how he has now outrun Dr Chan and has almost caught up to you."
            hide chan
    ...
    label hamp_tele:
        ...
        n "Dr Chan stops in front of you and looks around bewilderedly. {w=0.7} Out of the corner of your eye, you see Pochi reappear behind Plutoes, who purposely stopped a few steps behind Dr Chan."
        ...
        label expose_plutoes:
            ...
            n "You turn around to continue on your way, only to see your distorted reflection on a glass door. {w=0.7}Someone has left a disapproving message in red sharpie on your face of {cps=*0.75}{b}{color=#ff2d00}:({/color}{/b}{/cps}."
    ...
    label ignore_hampter:
        ...
        plutoes "{i}scribbles on floor{/i} {cps=*0.75}{b}{color=#ff2d00}Don't grab my dog :( I told him to kidnap Hampter, to free them from the dangerous work at the Demonic department.{/color}{/b}{/cps}"

        menu:
            n "Who should you listen to?"
            "Grab Pochi. Right your previous wrong of not helping poor Hampter.":
                jump grab_pochi
            "Do not grab Pochi. This cross-department conflict is out of your pay grade.":
                jump spare_pochi
            
        label grab_pochi:
            n "You grab the struggling Pochi from behind you. It wags its tail to try to hit you, but you athletically dodged its attempts and quickly hand it to Dr Syg."
            show plutoes upset
            ...
            n "Plutoes leaves. You hope Dr Syg vouches for you when the janitors report vandalism."
            hide plutoes
            syg pensive "Too bad I couldn't take its tail to sample..."
            hide hampter
            hide syg
            n "You watch Dr Syg walk away with a drained Hampter. You silently pray for Hampter's work at the Demonic department to go easy on them and not add to their exhaustion."
            $ update_character_points({"syg": 1})
            return
