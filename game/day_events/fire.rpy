label day_event_fire:
    ...
    label do_nothing:
        ...
        "\"Dr. Aikha can handle this just fine!\" you think to yourself as Dr. Firewal explodes with the force of a hydrogen bomb."
        scene bg hospital
        with ComposeTransition(default_fade, before=Fade(0.2, 1.5, 0.0, color="#ffffff"))
        "When you come to, you're lying in a hospital bed."
        "The blinding lights hurt your eyes, but you're able to barely make out two figures standing beside your bed."
        show aikha neutral at appear(x_align = 0.33)
        ...
        "You still cannot seem to form any words."
        aikha "Just..."
    ...
    label find_extinguisher:
        ...
        hide aikha
        hide firewal
        "You rush out into the hall, desperately searching for the fire extinguisher."
        "You spot it a little ways down the hall, and rush towards it."
        "Right after you break the glass and grab it, you hear a massive explosion coming from Dr. Firewal's office."
        "When the smoke clears, you see Dr. Aikha surrounded by debris."
        show aikha neutral at appear(x_align = 0.66)
        aikha "Hey, new recruit! What's that in your hands?"
        aikha "A fire extinguisher? Good thinking!"
        "Dr. Aikha takes the fire extinguisher and smashes it into whatever remains of the ceiling, spreading its contents all around the room."
        "It was surprisingly effective at spreading extinguisher all around the room."
